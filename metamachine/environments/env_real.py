...
class Real(Base):
    ...
    def update_config(self, cfg: OmegaConf) -> None:
        ...
        raise NotImplementedError(
            "Configuration update for real robot is not yet implemented"
        )
    ...
    def _is_truncated(self):
        ...
        """
        raise NotImplementedError(
            "Truncation check for real robot is not yet implemented"
        )
    ...
    def _get_observable_data(self):
        ...
        """
        raise NotImplementedError(
            "Observable data retrieval for real robot is not yet implemented"
        )

    def _wait_until_motor_on(self):
        """Wait until robot motors are ready and operational."""
        raise NotImplementedError(
            "Motor initialization waiting for real robot is not yet implemented"
        )
    ...
    def _perform_action(self, pos, vel=None, kps=None, kds=None):
        ...
        """
        raise NotImplementedError(
            "Action execution for real robot is not yet implemented"
        )
    ...
    def _check_input(self):
        ...
        raise NotImplementedError(
            "Input handling for real robot is not yet implemented"
        )
